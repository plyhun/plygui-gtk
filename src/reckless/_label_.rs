            ...
            use glib::translate::*;
            use gtk::{ Label, Buildable, Container, Widget };
            ...
            glib_wrapper! {
                pub struct RecklessLabel(Object<ffi::GtkRecklessLabel, ffi::GtkRecklessLabelClass>): [
                     Label => gtk_ffi::GtkLabel,
            ...
            impl RecklessLabel {
                pub fn new() -> RecklessLabel {
                    ...
                    unsafe { Widget::from_glib_none(ffi::reckless_label_new()).downcast_unchecked() }
                }
            }
